...
FDQ_Dungeons = {

  {
    ...
    quests = {
      ...
      { name = "Searching for the Lost Satchel", level = 9, faction = "Neutral", giver = "Grimtotem Satchel (drop from Maur Grimtotem)", location = "Inside Ragefire Chasm", notes = "Drop-only, not a normal pickup.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "The Glowing Shard", level = 10, faction = "Neutral", giver = "Drop from Mutanus the Devourer", location = "Wailing Caverns", notes = "Drop-only.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "The Unsent Letter", level = 16, faction = "Neutral", giver = "Drop from Edwin VanCleef", location = "The Deadmines", notes = "Drop-only. Prerequisite to pick up The Stockade Riots.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "Baron Aquanis", level = 21, faction = "Horde", giver = "Drop: Strange Water Globe from Baron Aquanis", location = "Blackfathom Deeps", notes = "Drop-only.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "Grime-Encrusted Ring", level = 28, faction = "Neutral", giver = "Drop: Grime-Encrusted Ring", location = "Gnomeregan", notes = "Drop-only. Starts Return of the Ring.", dungeonDrop = true },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "An Unholy Alliance", level = 28, faction = "Neutral", giver = "Drop: Small Scroll from Charlga Razorflank", location = "Razorfen Kraul", notes = "Drop-only. Prerequisite for the Razorfen Downs quest of the same name.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "The Essence of Eranikus", level = 48, faction = "Neutral", giver = "Drop: Essence of Eranikus", location = "Sunken Temple", notes = "Drop-only.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "General Drakkisath's Command", level = 55, faction = "Neutral", giver = "Drop from Overlord Wyrmthalak", location = "Blackrock Spire, Lower", notes = "Drop-only.", dungeonDrop = true },
      ...
      { name = "Seal of Ascension", level = 57, faction = "Neutral", giver = "Drop: Unadorned Seal of Ascension + 3 Gemstones", location = "Blackrock Spire, Lower", notes = "Drop-only.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "Healthy Dragon Scale", level = 55, faction = "Neutral", giver = "Drop from Plagued Hatchlings", location = "Scholomance", notes = "Repeatable for Argent Dawn rep. Complete Plagued Hatchlings first.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "The Truth Comes Crashing Down", level = 55, faction = "Neutral", giver = "Drop: Head of Balnazzar from Balnazzar", location = "Stratholme, Live Side", notes = "Drop-only. Complete The Archivist to be eligible.", dungeonDrop = true },
...

  {
    ...
    quests = {
      ...
      { name = "Blackhand's Command", level = 55, faction = "Neutral", giver = "Drop from Scarshield Quartermaster", location = "Blackrock Mountain, side hallway on the way to BWL", notes = "Drop-only.", dungeonDrop = true },
