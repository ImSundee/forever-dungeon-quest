...
FDQ_Dungeons = {
...

  {
    ...
    quests = {
      ...
      { name = "Leaders of the Fang", level = 15, faction = "Horde", giver = "Nara Wildmane", location = "Thunder Bluff, Elder Rise", coords = "45, 23", prereqs = { "The Barrens Oases", "The Forgotten Pools", "The Stagnant Oasis", "Altered Beings", "Hamuul Runetotem", "Nara Wildmane" } },
    },
  },
...

  {
    ...
    quests = {
      ...
      { name = "The Stockade Riots", level = 16, faction = "Alliance", giver = "Warden Thelwater", location = "Stormwind, outside Stockades", coords = "41, 58", prereqs = { "The Unsent Letter" } },
    },
  },
...

  {
    ...
    quests = {
      ...
      { name = "In the Name of the Light", level = 34, faction = "Alliance", giver = "Raleigh the Devout", location = "Hillsbrad Foothills, Southshore", coords = "51, 58", prereqs = { "Brother Anton", { name = "Down the Scarlet Path", id = 261 }, { name = "Down the Scarlet Path", id = 1052 } } },
      -- Graveyard
      ...
      { name = "Rituals of Power", level = 30, faction = "Neutral", giver = "Magus Tirth", location = "Thousand Needles, Shimmering Flats Raceway", coords = "78, 75", classOnly = "MAGE", notes = "Mage only.", prereqs = { "Journey to the Marsh", "Hidden Secrets", "Get the Scoop" } },
    },
  },
...

  {
    ...
    quests = {
      ...
      { name = "Agmond's Fate", level = 33, faction = "Alliance", giver = "Prospector Ironband", location = "Loch Modan, Ironband's Excavation Site", coords = "65, 65", prereqs = { "Ironband Wants You!", "Find Agmond", "Murdaloc" } },
      ...
      { name = "Power in Uldaman", level = 35, faction = "Neutral", giver = "Tabetha", location = "Dustwallow Marsh, N. of Stonemaul Ruins", coords = "46, 57", classOnly = "MAGE", notes = "Mage only.", prereqs = { "Return to the Marsh", "The Infernal Orb", "The Exorcism" } },
    },
  },

  {
    ...
    quests = {
      { name = "The Spider God", level = 40, faction = "Horde", giver = "Master Gadrin", location = "Durotar, Sen'jin Village", coords = "56, 74", prereqs = { "Venom Bottles", "Undamaged Venom Sac", "Consult Master Gadrin" } },
      { name = "Nekrum's Medallion", level = 40, faction = "Alliance", giver = "Thadius Grimshade", location = "Blasted Lands, Nethergarde Keep", coords = "66, 19", prereqs = { "Witherbark Cages", "The Altar of Zul", "Thadius Grimshade" } },
...

  {
    ...
    quests = {
      { name = "The Temple of Atal'Hakkar", level = 38, faction = "Horde", giver = "Fel'zerul", location = "Swamp of Sorrows, Stonard", coords = "47, 54", prereqs = { "Pool of Tears", "The Atal'ai Exile", "Return to Fel'Zerul" } },
      { name = "Zapper Fuel", level = 47, faction = "Neutral", giver = "Liv Rizzlefix", location = "The Barrens, Ratchet", coords = "62, 38", prereqs = { "Larion and Muigin", "Marvon's Workshop" } },
      { name = "Haze of Evil", level = 47, faction = "Neutral", giver = "Gregan Brewspewer", location = "Feralas, Twin Colossals", coords = "45, 25", notes = "Distinct chain from Zapper Fuel despite the similar breadcrumb name.", prereqs = { "Muigin and Larion", "A Visit to Gregan" } },
      { name = "Into The Temple of Atal'Hakkar", level = 38, faction = "Alliance", giver = "Brohann Caskbelly", location = "Stormwind, Dwarven District", coords = "64, 21", prereqs = { "In Search of The Temple", "To The Hinterlands", "Gryphon Master Talonaxe", "Rhapsody Shindigger", "Rhapsody's Kalimdor Kocktail", "Rhapsody's Tale" } },
      ...
      { name = "Into the Depths", level = 46, faction = "Neutral", giver = "Marvon Rivetseeker", location = "Tanaris, S. of Gadgetzan", coords = "52, 45", notes = "Shares this chain with Secret of the Circle.", prereqs = { "The Sunken Temple", "The Stone Circle" } },
      { name = "Secret of the Circle", level = 46, faction = "Neutral", giver = "Marvon Rivetseeker", location = "Tanaris, S. of Gadgetzan", coords = "52, 45", notes = "Shares this chain with Into the Depths.", prereqs = { "The Sunken Temple", "The Stone Circle" } },
      { name = "The God Hakkar", level = 40, faction = "Neutral", giver = "Yeh'kinya", location = "Tanaris, Steamwheedle Port", coords = "67, 22", prereqs = { "Screecher Spirits", "The Prophecy of Mosh'aru", "The Ancient Egg" } },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "Operation: Death to Angerforge", level = 52, faction = "Horde", giver = "Warlord Goretooth", location = "Badlands, Kargath", coords = "6, 47", notes = "Includes a long escort (Grark Lorkrub).", prereqs = { "KILL ON SIGHT: Dark Iron Dwarves", "KILL ON SIGHT: High Ranking Dark Iron Officials", "Grark Lorkrub", "Precarious Predicament" } },
      ...
      { name = "The Fate of the Kingdom", level = 50, faction = "Alliance", giver = "King Magni Bronzebeard", location = "Ironforge, Throne Room", coords = "39, 56", prereqs = { { name = "Kharan Mighthammer", id = 4341 } } },
...

  {
    ...
    quests = {
      ...
      { name = "The Final Tablets", level = 40, faction = "Neutral", giver = "Prospector Ironboot", location = "Tanaris, Steamwheedle Port", coords = "66, 24", prereqs = { "Screecher Spirits", "The Prophecy of Mosh'aru", "The Ancient Egg", "The God Hakkar", "The Lost Tablets of Mosh'aru" } },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "Dawn's Gambit", level = 57, faction = "Neutral", giver = "Betina Bigglezink", location = "Eastern Plaguelands, Light's Hope Chapel", coords = "81, 59", prereqs = { "Broodling Essence", "Felnok Steelspring", "Chillwind Horns", "Return to Tinkee", "Tinkee Steamboil", "Egg Freezing", "Egg Collection", "Leonid Barthalomew", "Betina Bigglezink" } },
...

  {
    ...
    quests = {
      ...
      { name = "Above and Beyond", level = 55, faction = "Neutral", giver = "Duke Nicholas Zverenhoff", location = "Eastern Plaguelands, Light's Hope Chapel", coords = "81, 59", prereqs = { "The Archivist", "The Truth Comes Crashing Down" } },
...

  {
    ...
    quests = {
      ...
      { name = "For The Horde!", level = 55, faction = "Horde", giver = "Thrall", location = "Orgrimmar, Valley of Wisdom", coords = "31, 37", prereqs = { "Warlord's Command", "Eitrigg's Wisdom" } },
      ...
      { name = "Egg Collection", level = 57, faction = "Neutral", giver = "Tinkee Steamboil", location = "Burning Steppes, Flame Crest", coords = "65, 23", notes = "Egg Freezing (the last prereq step) is not a second starting point.", prereqs = { "Broodling Essence", "Felnok Steelspring", "Chillwind Horns", "Return to Tinkee", "Tinkee Steamboil", "Egg Freezing" } },
      { name = "Eye of the Emberseer", level = 55, faction = "Neutral", giver = "Duke Hydraxis", location = "Azshara", coords = "79, 73", notes = "Stormers and Rumblers and Poisoned Water are both required, in any order.", prereqs = { "Stormers and Rumblers", "Poisoned Water" } },
