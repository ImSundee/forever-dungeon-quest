...
FDQ_Dungeons = {

  {
    ...
    quests = {
      ...
      { name = "Searching for the Lost Satchel", level = 9, faction = "Neutral", giver = "Grimtotem Satchel (drop from Maur Grimtotem)", location = "Inside Ragefire Chasm", notes = "Drop-only, not a normal pickup." },
...

  {
    ...
    quests = {
      ...
      { name = "Smart Drinks", level = 13, faction = "Neutral", giver = "Mebok Mizzyrix", location = "The Barrens, Ratchet", coords = "62, 37", notes = "Prerequisite: complete Raptor Horns from same NPC first." },
      ...
      { name = "The Glowing Shard", level = 10, faction = "Neutral", giver = "Drop from Mutanus the Devourer", location = "Wailing Caverns", notes = "Drop-only." },
...

  {
    ...
    quests = {
      ...
      { name = "The Unsent Letter", level = 16, faction = "Neutral", giver = "Drop from Edwin VanCleef", location = "The Deadmines", notes = "Drop-only. Prerequisite to pick up The Stockade Riots." },
...

  {
    ...
    quests = {
      ...
      { name = "Baron Aquanis", level = 21, faction = "Horde", giver = "Drop: Strange Water Globe from Baron Aquanis", location = "Blackfathom Deeps", notes = "Drop-only." },
...

  {
    ...
    quests = {
      ...
      { name = "The Fury Runs Deep", level = 25, faction = "Alliance", giver = "Motley Garmason", location = "Wetlands, Dun Modr", coords = "49, 18", notes = "Requires The Dark Iron War." },
      { name = "The Stockade Riots", level = 16, faction = "Alliance", giver = "Warden Thelwater", location = "Stormwind, outside Stockades", coords = "41, 58", notes = "Requires the quest line starting with The Unsent Letter from The Deadmines." },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "Chief Engineer Scooty", level = 20, faction = "Horde", giver = "Sovik", location = "Orgrimmar, Valley of Honor", coords = "76, 25", notes = "Must pick up Rig Wars first." },
      ...
      { name = "The Only Cure is More Green Glow", level = 20, faction = "Neutral", giver = "Ozzie Togglevolt", location = "Dun Morogh, Kharanos", coords = "45, 49", notes = "Complete Gnogaine first." },
      ...
      { name = "Grime-Encrusted Ring", level = 28, faction = "Neutral", giver = "Drop: Grime-Encrusted Ring", location = "Gnomeregan", notes = "Drop-only. Starts Return of the Ring." },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "An Unholy Alliance", level = 28, faction = "Neutral", giver = "Drop: Small Scroll from Charlga Razorflank", location = "Razorfen Kraul", notes = "Drop-only. Prerequisite for the Razorfen Downs quest of the same name." },
      { name = "The Crone of the Kraul", level = 29, faction = "Neutral", giver = "Falfindel Waywarder", location = "Feralas, The Lower Wilds", coords = "89, 46", notes = "Complete Lonebrow's Journal first." },
...

  {
    ...
    quests = {
      ...
      { name = "Hearts of Zeal", level = 30, faction = "Horde", giver = "Master Apothecary Faranell", location = "Undercity, The Apothecarium", coords = "48, 69", notes = "Requires Going, Going, Guano! (Razorfen Kraul) first." },
      -- Library
...

  {
    ...
    quests = {
      ...
      { name = "An Unholy Alliance", level = 28, faction = "Horde", giver = "Varimathras", location = "Undercity, Royal Quarter", coords = "36, 26", notes = "Requires An Unholy Alliance from Razorfen Kraul first." },
      ...
      { name = "Extinguishing the Idol", level = 32, faction = "Neutral", giver = "Belnistrasz", location = "Razorfen Downs, Murder Pens", notes = "Escort quest. Entire party must finish Scourge of the Downs first or they won't get credit." },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "Uldaman Reagent Run", level = 36, faction = "Horde", giver = "Jarkal Mossmeld", location = "Badlands, Kargath", coords = "3, 46", notes = "Complete Badlands Reagent Run first." },
      ...
      { name = "The Hidden Chamber", level = 35, faction = "Alliance", giver = "Baelog's Journal", location = "Uldaman, Lost Dwarves area", notes = "Complete The Lost Dwarves first." },
      { name = "Uldaman Reagent Run", level = 38, faction = "Alliance", giver = "Ghak Healtouch", location = "Loch Modan, Thelsamar", coords = "37, 49", notes = "Complete Badlands Reagent Run first." },
...

  {
    ...
    quests = {
      ...
      { name = "The Prophecy of Mosh'aru", level = 40, faction = "Neutral", giver = "Yeh'kinya", location = "Tanaris, Steamwheedle Port", coords = "67, 22", notes = "Complete Screecher Spirits first." },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "The Scepter of Celebras", level = 41, faction = "Neutral", giver = "Celebras the Redeemed", location = "Maraudon, Purple side", notes = "Complete Legends of Maraudon first." },
    },
  },

  {
    ...
    quests = {
      ...
      { name = "The Essence of Eranikus", level = 48, faction = "Neutral", giver = "Drop: Essence of Eranikus", location = "Sunken Temple", notes = "Drop-only." },
...

  {
    ...
    quests = {
      ...
      { name = "KILL ON SIGHT: High Ranking Dark Iron Officials", level = 50, faction = "Horde", giver = "WANTED poster", location = "Badlands, Kargath", coords = "4, 47", notes = "Complete KILL ON SIGHT: Dark Iron Dwarves first." },
      ...
      { name = "Disharmony of Fire", level = 48, faction = "Horde", giver = "Thunderheart", location = "Badlands, Kargath", coords = "3.6, 48.0", notes = "Opens after Disharmony of Flame." },
      { name = "Commander Gor'shak", level = 48, faction = "Horde", giver = "Galamav the Marksman", location = "Badlands, Kargath", coords = "6, 47", notes = "Opens after Disharmony of Flame." },
      { name = "The Last Element", level = 48, faction = "Horde", giver = "Shadowmage Vivian Lagrave", location = "Badlands, Kargath", coords = "3, 48", notes = "Opens after Disharmony of Flame." },
      ...
      { name = "Incendius!", level = 48, faction = "Alliance", giver = "Jalinda Sprig", location = "Burning Steppes, Morgan's Vigil", coords = "85, 70", notes = "Complete Overmaster Pyron first." },
      ...
      { name = "The Fate of the Kingdom", level = 50, faction = "Alliance", giver = "King Magni Bronzebeard", location = "Ironforge, Throne Room", coords = "39, 56", notes = "Chain of 2 starting with Kharan Mighthammer." },
...

  {
    ...
    quests = {
      ...
      { name = "Shards of the Felvine", level = 56, faction = "Neutral", giver = "Rabine Saturna", location = "Moonglade, Nighthaven", coords = "51, 45", notes = "Complete A Reliquary of Purity from the same NPC and explore all of Dire Maul first." },
...

  {
    ...
    quests = {
      ...
      { name = "Foror's Compendium", level = 60, faction = "Neutral", giver = "Nostro's Compendium of Dragon Slaying", location = "Dire Maul", notes = "Rare drop, or looted from A Dusty Tome. Not BoP; used to craft a BoP tanking sword (item #18348)." },
    },
  },
...

  {
    ...
    quests = {
      ...
      { name = "General Drakkisath's Command", level = 55, faction = "Neutral", giver = "Drop from Overlord Wyrmthalak", location = "Blackrock Spire, Lower", notes = "Drop-only." },
      ...
      { name = "Seal of Ascension", level = 57, faction = "Neutral", giver = "Drop: Unadorned Seal of Ascension + 3 Gemstones", location = "Blackrock Spire, Lower", notes = "Drop-only." },
...

  {
    ...
    quests = {
      ...
      { name = "The Darkreaver Menace", level = 58, faction = "Horde", giver = "Sagorne Creststrider", location = "Orgrimmar, Valley of Wisdom", coords = "38, 35", notes = "Shaman only. Complete Material Assistance first." },
      ...
      { name = "Healthy Dragon Scale", level = 55, faction = "Neutral", giver = "Drop from Plagued Hatchlings", location = "Scholomance", notes = "Repeatable for Argent Dawn rep. Complete Plagued Hatchlings first." },
      ...
      { name = "Krastinov's Bag of Horrors", level = 55, faction = "Neutral", giver = "Eva Sarkhoff", location = "Western Plaguelands, Caer Darrow", coords = "70, 73", notes = "Complete Doctor Theolen Krastinov, the Butcher first." },
      { name = "Kirtonos the Herald", level = 55, faction = "Neutral", giver = "Eva Sarkhoff", location = "Western Plaguelands, Caer Darrow", coords = "70, 73", notes = "Complete Krastinov's Bag of Horrors first; keep item #13544." },
...

  {
    ...
    quests = {
      ...
      { name = "The Medallion of Faith", level = 55, faction = "Neutral", giver = "Aurius", location = "Stratholme, Undead Side, inside chapel at beginning", notes = "Complete The Restless Souls (Undead side) first." },
      { name = "The Truth Comes Crashing Down", level = 55, faction = "Neutral", giver = "Drop: Head of Balnazzar from Balnazzar", location = "Stratholme, Live Side", notes = "Drop-only. Complete The Archivist to be eligible." },
...

  {
    ...
    quests = {
      ...
      { name = "The Active Agent", level = 55, faction = "Neutral", giver = "Betina Bigglezink", location = "Eastern Plaguelands, Light's Hope Chapel", coords = "81, 59", notes = "Complete The Flesh Does Not Lie first." },
      { name = "Aurius' Reckoning", level = 55, faction = "Neutral", giver = "Aurius", location = "Stratholme, Undead Side, chapel at beginning", notes = "Complete The Medallion of Faith first." },
...

  {
    ...
    quests = {
      ...
      { name = "General Drakkisath's Demise", level = 55, faction = "Alliance", giver = "Marshal Maxwell", location = "Burning Steppes, Morgan's Vigil", coords = "84, 68", notes = "Requires General Drakkisath's Command first." },
      ...
      { name = "Blackhand's Command", level = 55, faction = "Neutral", giver = "Drop from Scarshield Quartermaster", location = "Blackrock Mountain, side hallway on the way to BWL", notes = "Drop-only." },
      ...
      { name = "The Demon Forge", level = 55, faction = "Neutral", giver = "Lorax", location = "Winterspring, Southeast", coords = "63, 73", notes = "Blacksmiths only. Complete Lorax's Tale first. Rewards Plans: Demon Forged Breastplate." },
    },
  },
}
