...
FDQ_Dungeons = {
...

  {
    ...
    quests = {
      ...
      { name = "The Truth Comes Crashing Down", level = 55, faction = "Neutral", giver = "Drop: Head of Balnazzar from Balnazzar", location = "Stratholme, Live Side", notes = "Drop-only. Complete The Archivist to be eligible.", dungeonDrop = true, prereqs = { "The Archivist" } },
